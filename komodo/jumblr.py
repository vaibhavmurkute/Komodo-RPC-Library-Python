...
def jumblr_deposit(depositaddress=''):
    ...
    :param depositaddress: (string, required) the address from which Jumblr will withdraw funds
    :return: JSON string
    '''
...
def jumblr_secret(secretaddress=''):
    ...
    :param secretaddress: (string, required) the destination transparent address
    :return: JSON string
    '''
